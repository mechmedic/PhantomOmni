...
//    QStatusBar *statusbar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btnStopOmni = new QPushButton(centralwidget);
        btnStopOmni->setObjectName(QString::fromUtf8("btnStopOmni"));
        sizePolicy.setHeightForWidth(btnStopOmni->sizePolicy().hasHeightForWidth());
        btnStopOmni->setSizePolicy(sizePolicy);
        btnStopOmni->setStyleSheet(DeviceBtnStyleStr);
        device_ui_layout->addWidget(btnStopOmni);
        ...
        sizePolicy.setHeightForWidth(btnStopServer->sizePolicy().hasHeightForWidth());
        btnStopServer->setSizePolicy(sizePolicy);
        btnStopServer->setStyleSheet(DeviceBtnStyleStr);
        ntwk_ui_layout->addWidget(btnStopServer);
...
//        lblMessage->setText(QCoreApplication::translate("MainWindow", "Device Status", nullptr));
        ...
        btnStopOmni->setText(QCoreApplication::translate("MainWindow", "Stop Omni", nullptr));
